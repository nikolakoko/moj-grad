...
public class ComplaintController {
    ...
    public ResponseEntity<Void> updateDepartment(@PathVariable Long id,
        ...
        complaintService.updateDepartment(id, departmentId);
    ...
    public ResponseEntity<Void> updateStatus(@PathVariable Long id,
                                             ...
                                             Authentication authentication) {
        complaintService.updateStatus(id, status, authentication);
        return ResponseEntity.ok().build();
    }
    //Priority endpoint
    ...
    public ResponseEntity<Void> updatePriority(@PathVariable Long id,
                                               ...
                                               Authentication authentication) {
        complaintService.updatePriority(id, priority, authentication);
        return ResponseEntity.ok().build();
    }
}