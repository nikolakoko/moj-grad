              ...
              {foundComplaint ? (
                <div className="border-2 border-blue-200 rounded-xl p-6 bg-blue-50/50 space-y-6">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 text-sm">Датум на поднесување</h4>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t">
                    <div>
                      ...
                      <span className={`inline-flex px-3 py-1 rounded-full text-xs font-medium ${statusColors[foundComplaint.complaintStatus] ?? 'bg-gray-100 text-gray-800'}`}>
                    ...
                    <div>
                      ...
                      <span className={`inline-flex px-3 py-1 rounded-full text-xs font-medium ${priorityColors[foundComplaint.priority] ?? 'bg-gray-100 text-gray-800'}`}>
                ...
                <div className="border-2 border-red-200 bg-red-50 rounded-xl p-6">
                  <div className="text-center space-y-3">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Жалбата не е пронајдена</h3>
                    <p className="text-gray-600">
                      {error ?? 'Не постои жалба со овој токен. Ве молиме проверете го и обидете се повторно.'}
                    </p>
                  </div>
                </div>
              )}
