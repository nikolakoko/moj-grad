...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Department infrastructure = departmentRepository.findByName("Инфраструктура");
        Department utilities = departmentRepository.findByName("Комунални услуги");
        Department sanitation = departmentRepository.findByName("Хигиена");
